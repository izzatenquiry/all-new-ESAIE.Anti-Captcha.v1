        ...
        <div className="max-w-5xl mx-auto pb-20">
            ...
            <div className="text-center mb-10 sm:mb-16">
                ...
                <p className="text-sm sm:text-lg text-neutral-500 dark:text-neutral-400 max-w-2xl mx-auto">
                    Panduan komprehensif anda untuk menguasai platform AI ESAIE.
                </p>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 p-6 sm:p-12 rounded-3xl shadow-soft border border-neutral-100 dark:border-neutral-800">
                ...
                <Section title="Gambaran Keseluruhan: Cara ESAIE Berfungsi" icon={InformationCircleIcon}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                        <div className="bg-orange-50 dark:bg-orange-900/10 p-5 rounded-xl border border-orange-100 dark:border-orange-900/30">
                            <h5 className="font-bold text-brand-start mb-2">🚗 Platform ESAIE (Kereta)</h5>
                        ...
                        <div className="bg-yellow-50 dark:bg-yellow-900/10 p-5 rounded-xl border border-yellow-100 dark:border-yellow-900/30">
                            <h5 className="font-bold text-brand-end mb-2">⛽ Token ESAIE (Bahan Api)</h5>
                ...
                <Section title="Bab 1: Akaun & Token" icon={KeyIcon}>
                    ...
                    <SubSection title="Token: Automatik Sepenuhnya!">
                        ...
                        <p>Platform ESAIE menguruskan semuanya untuk anda. Apabila anda log masuk, sistem secara automatik memuatkan token pusat yang dikongsi yang memberi anda akses kepada semua ciri AI. Anda boleh mengesahkan token itu aktif dengan mencari ikon <KeyIcon className="w-4 h-4 inline-block text-green-500" /> di penjuru kanan atas skrin.</p>
                ...
                <Section title="Bab 2: Memahami Kos & Pengebilan" icon={CreditCardIcon}>
                    <p className="font-semibold text-neutral-800 dark:text-neutral-200">ESAIE beroperasi berdasarkan langganan, yang merangkumi akses anda ke platform dan kos penggunaan AI.</p>
                    <ul className="space-y-3 mt-4">
                        ...
                        <li className="flex gap-3"><span className="w-1.5 h-1.5 rounded-full bg-neutral-400 mt-2 flex-shrink-0"></span><span><strong>Anda Mengawal Sepenuhnya:</strong> Akses anda diuruskan sepenuhnya melalui status akaun anda. Anda tidak memerlukan akaun Google Cloud atau persediaan pengebilan yang berasingan.</span></li>
                    </ul>
                </Section>
                ...
                <Section title="Bab 3: Suite Idea Kandungan AI" icon={LightbulbIcon}>
                    <p>Suite ini direka untuk membantu anda sumbang saran dan mencipta kandungan bertulis untuk keperluan pemasaran anda.</p>
                     <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        <li className="bg-neutral-50 dark:bg-neutral-800/30 p-4 rounded-xl text-xs sm:text-sm"><strong className="block text-brand-start mb-1">Staf ESAIE</strong> Satu pasukan ejen AI khusus. Pilih ejen (seperti Penyelidik Pasaran atau Penulis Iklan), berikan input anda, dan dapatkan output peringkat pakar untuk tugas-tugas tertentu.</li>
