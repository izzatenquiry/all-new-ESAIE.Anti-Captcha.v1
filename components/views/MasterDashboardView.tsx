             ...
             {previewItem && (
                <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" onClick={() => setPreviewItem(null)}>
                    ...
                    <div className="max-w-5xl max-h-full flex flex-col items-center" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="mt-4">
                             <button 
                                onClick={() => downloadContent(previewItem.url, previewItem.type, 'esaie-test')}
                    ...
                    <div className="lg:col-span-2 flex flex-col h-full">
                        ...
                        <div className="mt-auto space-y-2">
                            <div className="flex gap-4">
                                <button onClick={() => handleRunTests('T2I')} className="flex-1 bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md flex items-center justify-center gap-2">
                                    <ImageIcon className="w-5 h-5" /> {isLooping && lastTestType === 'T2I' ? 'Looping T2I...' : 'Test T2I'}
                                </button>
                                <button onClick={() => handleRunTests('I2I')} disabled={!hasRefImages} className="flex-1 bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed">
                                ...
                                <div className="flex items-center justify-between px-2 py-1.5 bg-neutral-50 dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button 
                                            ...
                                            className="text-[10px] font-semibold text-yellow-600 hover:underline disabled:opacity-50"
                                        >
                                            I2I
                                        </button>
                                        <button 
