    ...
    return (
        <div className="flex flex-col h-full space-y-4">
            <div>
                ...
                <p className="text-neutral-500 dark:text-neutral-400 mt-1">Real-time health check of all shared tokens. Testing both <strong className="text-orange-500">Imagen</strong> and <strong className="text-pink-500">Veo 3</strong> services.</p>
            </div>
                ...
                <div className="p-4 border-b border-neutral-200 dark:border-neutral-800 flex flex-col gap-4 bg-neutral-50 dark:bg-neutral-800/30">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center gap-4">
                             ...
                             {isScanning && (
                                 <div className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded-full flex items-center gap-2">
                             ...
                             <div className="flex gap-3 text-xs ml-4 border-l border-neutral-300 dark:border-neutral-700 pl-4">
                                 <div className="flex items-center gap-1"><div className="w-2 h-2 bg-orange-500 rounded-full"></div> Imagen</div>
                                ...
                                return (
                                    <tr key={token.token} className="bg-white dark:bg-neutral-900 hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                                        ...
                                        <td className="px-2 py-2 text-center border-r border-neutral-200 dark:border-neutral-700">
                                            <div className="flex items-center justify-center gap-1 text-xs font-semibold text-orange-600 dark:text-orange-400">
                                                    ...
                                                    <div className="flex justify-center items-center h-full">
                                                        {cell?.status === 'testing' ? (
                                                            ...
                                                            <div className="flex gap-1 bg-neutral-100 dark:bg-neutral-800 p-1 rounded-md border border-neutral-200 dark:border-neutral-700">
                                                                {/* Imagen Indicator */}
                                                                <div className={`w-3 h-3 rounded-full ${cell?.imagen ? 'bg-orange-500 shadow-[0_0_5px_rgba(249,115,22,0.6)]' : 'bg-neutral-300 dark:bg-neutral-600 opacity-30'}`} title={`Imagen: ${cell?.imagen ? 'OK' : 'FAIL'}`}></div>
                                                                {/* Veo Indicator */}
