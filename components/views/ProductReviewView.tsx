    ...
    <div className="space-y-8">
      <div>
        ...
        <div className="flex gap-2 mt-2">
            <div className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-orange-50 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300 text-xs font-medium border border-orange-100 dark:border-orange-800">
      ...
      <div className="bg-white dark:bg-neutral-900 p-6 rounded-lg shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-800/50 rounded-lg p-4 relative min-h-[300px] flex flex-col">
            ...
            {storyboard && (
                 <button onClick={() => downloadText(storyboard, `esaie-storyboard-${Date.now()}.txt`)} className="absolute top-4 right-4 text-xs bg-neutral-200 dark:bg-neutral-700 py-1 px-3 rounded-full flex items-center gap-1 z-10">
                    ...
                    {editingSceneIndex === i ? (
                        ...
                        <div className="grid grid-cols-1 gap-2">
                            ...
                            <a
                                ...
                                download={generatedImages[i] && typeof generatedImages[i] === 'string' ? `esaie-scene-${i + 1}.png` : undefined}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Array.from({ length: 4 }).map((_, i) => (
                 <div key={`video-scene-${i}`} className="bg-neutral-100 dark:bg-neutral-800/50 p-3 rounded-lg flex flex-col gap-3">
                    ...
                    <button
                        onClick={() => handleDownloadVideo(generatedVideos[i], videoFilenames[i] || `esaie-scene-${i+1}.mp4`, i)}
