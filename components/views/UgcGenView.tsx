                    ...
                    <div className="flex gap-2 mb-3">
                        ...
                        >
                         ...
                         <button 
                            ...
                            className="w-20 flex justify-center items-center px-3 py-2 bg-orange-600 text-white text-xs font-bold rounded hover:bg-orange-700 disabled:opacity-50"
                        >
    ...
    const leftPanel = (
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="mt-auto space-y-2"><div className="flex gap-4"><button onClick={() => handleRunTests('T2I')} disabled={hasRefImages} className="flex-1 bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"><ImageIcon className="w-5 h-5" /> Create T2I</button><button onClick={() => handleRunTests('I2I')} disabled={!hasRefImages} className="flex-1 bg-yellow-600 hover:bg-yellow-700 text-white font-bold py-3 px-4 rounded-lg transition-colors shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"><RefreshCwIcon className="w-5 h-5" /> Create I2I</button></div></div>
            </div>
        </>
    );
...
const StatusBadge: React.FC<{ status: Status }> = ({ status }) => {
    const colors = {
        ...
        uploading: 'bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300',
