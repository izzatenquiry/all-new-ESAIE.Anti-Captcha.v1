...
Please find payment proof attached.`;
  ...
  const telegramUrl = `https://t.me/esaie_support?text=${encodeURIComponent(message)}`;
      ...
      >
        ...
        <div className="space-y-4">
          <p className="text-sm text-neutral-600 dark:text-neutral-400">
            Share your registration details to <strong>@esaie_support</strong> via Telegram. The message is pre-filled with your information.
          </p>
