...
const TUTORIAL_CONTENT_KEY = 'esaie-ai-tutorial-content';
const PLATFORM_STATUS_KEY = 'esaie-ai-platform-status';
const ANNOUNCEMENTS_KEY = 'esaie-ai-announcements';

const defaultTutorialContent: TutorialContent = {
  mainVideoUrl: 'https://www.youtube.com/embed/G6G8JJrV9V',
  mainTitle: 'Welcome to ESAIE',
  mainDescription: 'Welcome! This video is your introduction to the ESAIE platform. Understand the big picture, the powerful features, and how to get started on your creative projects with the help of AI.',
  tutorials: [
...
const defaultAnnouncements: Announcement[] = [
    {
        id: 'anno-1',
        title: '-',
        content: 'SELAMAT TAHUN BARU 2026!',
        category: 'General',
